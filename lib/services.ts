    ...
    why: [
      {
        ...
        desc: "Our truck-mounted hot-water extraction lifts embedded grime that surface cleaners leave behind.",
      },
      {
        icon: 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z',
        title: 'Leather-Safe Products',
        desc: 'We use pH-balanced cleaners and conditioning treatments that protect and restore leather long-term.',
      },
      {
        icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z',
        title: 'Odor Elimination',
        desc: "We treat the source of odors — not just mask them — for a genuinely fresh-smelling cabin.",
      },
    ],
  },
